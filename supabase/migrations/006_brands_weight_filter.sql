-- Agrega filtros SQL duros para brands_excluded y max_weight_kg.
-- Ambos eran post-filtros en la capa de aplicación; ahora se aplican en la DB
-- para que el pool de 200 candidatos ya esté limpio antes del re-ranking.
